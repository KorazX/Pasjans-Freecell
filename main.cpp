...
void POMOC() {
   cout << "ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป" << endl
        << "บ                               PASJANS 1.4                                       บ" << endl
        << "ฬอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออน" << endl
        << "บ                                                                                 บ" << endl
        << "บ Legenda:                                                                        บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ x - Pik              C - Krol           Przyklady:                              บ" << endl
        << "บ X - Trefl            Q - Dama                                                   บ" << endl
        << "บ y - Karo             J - Walet          2x - 3 Pik                              บ" << endl
        << "บ Y - Kier             10 - 10            CY - Krol Kier                          บ" << endl
        << "บ                      9 - 9              0y - As Karo                            บ" << endl
        << "บ                      8 - 8                                                      บ" << endl
        << "บ                      7 - 7                                                      บ" << endl
        << "บ                      6 - 6                                                      บ" << endl
        << "บ                      5 - 5                                                      บ" << endl
        ...
        << "บ  Opis:                                                                          บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ  Celem gry jest jest przeniesienie wszystkich kart z pola gry (kolumny 1-8)     บ" << endl
        << "บ  do pol koncowych (X, x, Y, y). W polach koncowych karty odkladane sa w         บ" << endl
        << "บ  kolejnosci od Asa do Krola (0 - C). Gracz moze przenosic karty miedzy          บ" << endl
        << "บ  kolumnami pola gry pod warunkiem ze przenoszona karta ma wartosc o 1 mniejsza  บ" << endl
        << "บ  od ostatniej ostatniej karty w kolumnie do ktorej ja przenosi oraz jest innego บ" << endl
        << "บ  znaku. Ponadto do dyspozycji sa pola tymczasowe (A -D) do ktorych mozna        บ" << endl
        << "บ  przeniesc 1 dowolna   karte, a nastepnie przeniesc ja z powrotem do pola gry   บ" << endl
        << "บ  lub pola koncowego. Nie ma mozliwosci zabrania kart z pol koncowych.           บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ  Ruch:                                                                          บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ  Aby przeniesc karte, nalezy podac kolumne z ktorej karta ma byc przeniesiona,  บ" << endl
        << "บ  nacisnac przycisk ENTER, a nastepnie podac kolumne docelowa i zatwierdzic      บ" << endl
        << "บ  ENTER.                                                                         บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ     Przyklady:                                                                  บ" << endl
        << "บ     2  ENTER 3  - przenies karte z kolumny 2 do kolumny 3                       บ" << endl
        << "บ     4  ENTER A  - przenies karte z kolumny 4 do pola tymczasowego A             บ" << endl
        << "บ     D  ENTER Y  - przenies karte z pola tymczasowego D do pola koncowego Kier   บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ   Powodzenia!                                                                   บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ   Lista wprowadzanych zmian dostepna po wpisaniu changelog                      บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ   Autor:                                                                        บ" << endl
        << "บ                                                                                 บ" << endl
        << "บ   Koraz                                                                         บ" << endl
        << "บ   Robert Czapiewski EiT 1                                                       บ" << endl
        << "บ                                                                                 บ" << endl
        << "ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ" << endl
        ;
}
...
void CHANGELOG() {
    cout<< "ษอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป" << endl
        << "บ                                       CHANGELOG                                         บ" << endl
        << "ฬอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออน" << endl
        << "บ  Wersja 1.4                                                                             บ" << endl
        << "บ  -Zmiana ramek ze znakow '=' na elementy budowania GUI                                  บ" << endl
        << "บ  -Poprawa skladni kodu                                                                  บ" << endl
        << "บ                                                                                         บ" << endl
        << "บ  Wersja 1.3                                                                             บ" << endl
        << "บ  -Normalne oznaczenia kart A-as K-krol itd. oraz liczone normalnie od 2 do 10           บ" << endl
        << "บ                                                                                         บ" << endl
        << "บ  Wersja 1.2.1                                                                           บ" << endl
        << "บ  -Do przenoszenia na pola tymczasowe mozna teraz uzywac malych liter                    บ" << endl
        << "บ  -Transformacja kodu aby nie korzystal z tzw. zmiennych globalnych                      บ" << endl
        << "บ                                                                                         บ" << endl
        << "บ  Wersja 1.2                                                                             บ" << endl
        << "บ  -Dodano mechanizm sprawdzajacy ilosc mozliwych ruchow                                  บ" << endl
        << "บ  -Uniemozliwienie blednego przenoszenia kart w obaszarze pola                           บ" << endl
        << "บ  -Uniemozliwienie blednego przenoszenia z pol dodatkowych na koncowe                    บ" << endl
        << "บ  -Uniemozliwienie przenoszenia kart z pol koncowych                                     บ" << endl
        << "บ  -Dodano wyswietlanie iformacji w wypadku gdy mozliwe jest przeniesienie na pole        บ" << endl
        << "บ   koncowe                                                                               บ" << endl
        << "บ                                                                                         บ" << endl
        << "บ  Wersja 1.1                                                                             บ" << endl
        << "บ  -Uniemozliwienie przeniesienia karty na pola ABCD, gdy juz znajduje sie na nich karta  บ" << endl
        << "บ  -Uniemozliwienie przeniesienia kart na pola koncowe bez zachowania kolejnosci i znaku  บ" << endl
        << "บ  -Wprowadzenie CHANGELOG'u                                                              บ" << endl
        << "บ  -Zamiana kolejnosci pol koncowych na bardziej intuicyjne                               บ" << endl
        << "บ                                                                                         บ" << endl
        << "บ  Wersja 1.0                                                                             บ" << endl
        << "บ  -Pierwsza wersja stabilna - uniemozliwienie crash'u gry poprzez wpisywanie blednych    บ" << endl
        << "บ   wartosci.                                                                             บ" << endl
        << "บ  -Wprowadzenie pomocy                                                                   บ" << endl
        << "บ                                                                                         บ" << endl
        << "ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ" << endl;
}
int main()
{
    ///////////////////////////////Inicjacja///////////////////////////////////
